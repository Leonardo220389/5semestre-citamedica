<div class="container p-3">
    <form class="row g-3" action="envio_crear.php?idpaciente= <?php echo $_GET['idpaciente']; ?>" method="POST">
        <h5 class="text-center">CREAR CITA MÉDICA</h5>
        <div class="col-md-4">
        ...
        <div class="col-md-4">
            <div class="form-group mb-2">
                ...
                <input type="date" name="fecha_atencion" class="form-control" placeholder="DD/MM/YYYY" value="" autofocus requerid>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-group mb-2">
                <label for="" class="form-label"><b>Hora de Atención</b></label>
                <input type="time" name="hora_atencion" class="form-control" placeholder="DD/MM/YYYY" value="" autofocus requerid>
            </div>
        </div>
        <div class="col-12">
            <input type="submit" class="btn btn-success btm-block" name="crear" value="Crear Cita Médica">
        </div>
    </form>
</div>